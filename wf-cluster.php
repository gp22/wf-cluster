 ...
 */
function wazframe_wf_cluster_block_init()
{
	register_block_type(__DIR__ . '/build');
}

add_action('init', 'wazframe_wf_cluster_block_init');
...
function add_wf_cluster_to_kses_allowed($allowed_tags)
{
	$allowed_tags['wf-cluster'] = array();
}

//add_filter('wp_kses_allowed_html', 'add_wf_cluster_to_kses_allowed');
